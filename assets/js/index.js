...
function sizeChk(){
    $('.sc-learn .group-bottom .learn-list .learn-item .name2').each(function(){
        setTimeout(() => {
            ...
            $(this).siblings('.name-box').css('--name2-width', name2Width + 'px');
            $(this).siblings('.name-box').css('--name-offset', nameOffset + 'px');
            $(this).siblings('.name-box').css('--minus-width', minusWidth + 'px');
        }, 100);
    })
